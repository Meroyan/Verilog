...
module alu(
    ...
    assign alu_smtu  = alu_control[2];
    assign alu_nand  = alu_control[1];
    assign alu_mui  = alu_control[0];
...
//    assign alu_lui  = alu_control[ 0];
    ...
    assign mui_result = {16'd0, alu_src2[31:16]};  // （新增）立即数装载结果为立即数移位至低半字节
...
//add,sub,slt,sltu均使用该模块
    ...
    assign smtu_result = {31'd0, ~sltu_result};
